...
export default function Navbar() {
  ...
  const getHref = (href: string) => {
    ...
    if (href.startsWith('/#')) {
      return isHome ? href.replace('/', '') : href;
    }
    return href;
  };
    ...
    <>
      ...
      >
        <nav className="s-nav__inner">
          ...
          <div className="s-nav__links">
            ...
            <Link to="/work">Showreel</Link>
          </div>
          <a className="s-nav__cta" href={isHome ? "#contact" : "/#contact"}>Let's Talk <ArrowUpRight size={14} /></a>
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <Link to="/work" onClick={() => setIsOpen(false)}>Work &amp; Showreel</Link>
            <a href={isHome ? "#services" : "/#services"} onClick={() => setIsOpen(false)}>Services</a>
            <a href={isHome ? "#about" : "/#about"} onClick={() => setIsOpen(false)}>About</a>
            <a href={isHome ? "#experience" : "/#experience"} onClick={() => setIsOpen(false)}>Experience</a>
            <a className="s-mobile-menu__cta" href={isHome ? "#contact" : "/#contact"} onClick={() => setIsOpen(false)}>
