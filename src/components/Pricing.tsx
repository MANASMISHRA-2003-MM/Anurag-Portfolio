    ...
    <section id="work" className="section section--black work-section">
      ...
      <div className="work-grid">
        {portfolio.projects.map((p,i)=>(
          <motion.a href={p.href || '#contact'} key={p.id} className={`work-card work-card--${i%2?'tall':'wide'}`} initial={{opacity:0,scale:.98}} whileInView={{opacity:1,scale:1}} viewport={{once:true,amount:.15}} transition={{duration:.8}}>
